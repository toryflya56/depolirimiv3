    ...
    <main className='min-h-screen bg-deep-950 pt-20 pb-24'>
      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        <div className='text-center mb-12 mt-8'>
          <h1 className='text-4xl md:text-5xl font-serif text-white mb-4'>Secure Your Spot</h1>
        ...
        <div className='text-center mt-12 space-y-2'>
          <p className='text-sm text-gray-500 uppercase tracking-wider'>Secure Booking • Instant Confirmation</p>
          <p className='text-xs text-gray-600'>Cancellation Policy: Please notify us 24 hours in advance.</p>
        </div>
      </div>
    </main>
  );
