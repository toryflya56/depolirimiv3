...
export const CTASection: React.FC = () => {
  return (
    <section className="relative bg-cover bg-center py-20 md:py-28 text-center text-white" style={{backgroundImage: "url('/images/cta-bg.jpg')"}}>
      <div className="absolute inset-0 bg-deep-900/80"></div>
