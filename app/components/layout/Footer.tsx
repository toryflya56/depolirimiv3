        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href={APP_ROUTES.HOME} className="text-gray-400 hover:text-cyber">Home</a></li>
              <li><a href={APP_ROUTES.SERVICES} className="text-gray-400 hover:text-cyber">Services</a></li>
              <li><a href={APP_ROUTES.ABOUT} className="text-gray-400 hover:text-cyber">About Us</a></li>
              <li><a href={APP_ROUTES.BOOKING} className="text-gray-400 hover:text-cyber">Book Now</a></li>
            </ul>
          </div>
          <div>
