import { Barber, Service, Testimonial } from '@/models/common';
...
export const MOCK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: "The best haircut I've ever had. Julian's attention to detail is unmatched. The atmosphere is amazing, and I always leave feeling like a new man.",
    rating: 5,
  },
  {
    id: '2',
    ...
    quote: "Alex is a true artist! He gave me the perfect modern fade. The studio is clean, stylish, and has a great vibe. I wouldn't go anywhere else.",
    rating: 5,
  },
  {
    id: '3',
    ...
    quote: "A truly professional and relaxing experience. The hot towel shave is a must-try. The entire team is welcoming and skilled. Highly recommended!",
    rating: 5,
  },
  {
    id: '4',
    ...
    quote: "Leo's creative vision is incredible. He gave my husband a stylish new look that we both love. The studio has a cool, industrial-chic aesthetic.",
    rating: 5,
  },
];
